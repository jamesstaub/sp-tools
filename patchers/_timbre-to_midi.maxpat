...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 291.845498085021973, 690.49786451458931, 76.82403552532196, 19.545064866542816 ],
					"presentation" : 1,
					"presentation_rect" : [ 250.98040771484375, 194.117659091949463, 90.980376720428467, 19.607844352722168 ],
					"prototypename" : "onoff",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 291.845498085021973, 736.05151355266571, 33.0, 22.0 ],
					"text" : "== 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 169.607853651046753, 713.725534439086914, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.566525101661682, 755.794003129005432, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 109.44206178188324, 724.892715096473694, 22.0, 22.0 ],
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 109.5, 689.270396947860718, 34.0, 22.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 957.0, 338.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 926.0, 338.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 926.0, 302.0, 71.0, 22.0 ],
					"text" : "sel 104 107"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 926.0, 267.0, 50.5, 22.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 664.0, 543.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 371.0, 740.0, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 371.0, 772.0, 81.0, 34.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 179.411775827407837, 171.56863808631897, 67.0, 19.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 903.0, 440.0, 47.0, 22.0 ],
					"text" : "* 2000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 854.0, 453.0, 34.0, 22.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 854.0, 491.0, 55.0, 22.0 ],
					"text" : "del 4000"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 168.0, 174.0, 34.0, 22.0 ],
									"text" : "sel 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 168.0, 147.0, 29.5, 22.0 ],
									"text" : "&&"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 104.0, 142.0, 46.0, 22.0 ],
									"text" : "< 1000"
								}
...
,
					"patching_rect" : [ 805.0, 380.0, 103.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
					"text" : "p noteoff-on-short"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 646.0, 342.5, 150.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 664.0, 483.0, 128.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 185.0, 128.0, 20.0 ],
					"prototypename" : "onoff",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "Off", "On" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 709.0, 414.0, 37.0, 22.0 ],
					"text" : "* 150"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 693.75, 448.0, 29.5, 22.0 ],
					"text" : ">"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 200.75, 404.0, 74.0, 22.0 ],
									"text" : "vexpr $i1 / 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 200.75, 367.0, 53.0, 22.0 ],
									"text" : "zl sum 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 245.0, 150.0, 20.0 ],
									"text" : "avg recent duration"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "int" ],
									"patching_rect" : [ 192.75, 292.0, 48.0, 22.0 ],
									"text" : "change"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 202.0, 208.0, 29.5, 22.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 200.75, 328.0, 32.0, 22.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 223.0, 252.0, 32.0, 22.0 ],
									"text" : "> 20"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 257.0, 134.0, 34.0, 22.0 ],
									"text" : "sel 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "int", "int", "int" ],
									"patching_rect" : [ 207.0, 177.0, 40.0, 22.0 ],
									"text" : "peak"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "int", "int", "int" ],
									"patching_rect" : [ 184.0, 100.0, 65.0, 22.0 ],
									"text" : "unpack i i i"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 200.75, 486.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 697.82607364654541, 278.0, 123.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 747.0, 224.0, 65.0, 22.0 ],
					"text" : "r envelope"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 165.0, 204.0, 22.0, 22.0 ],
									"text" : "t 0"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 162.0, 134.0, 22.0 ],
									"text" : "sel bow bow_hi tremolo"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 74.5, 100.0, 85.0, 22.0 ],
									"text" : "r rt-classname"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 101.5, 286.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 22.0, 491.0, 70.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
,
					"patching_rect" : [ 526.5, 641.0, 113.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
					"text" : "p speed-to-duration"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 22.0, 449.0, 128.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 169.0, 128.0, 20.0 ],
					"prototypename" : "onoff",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "Off", "On" ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 70.0, 198.0, 110.0, 28.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 115.0, 33.0, 224.761933565139771, 28.0 ],
					"textcolor" : [ 0.780392156862745, 0.929411764705882, 1.0, 1.0 ],
					"varname" : "quantize-scale"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 122.0, 96.0, 26.0 ],
					"text" : "midi note"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 697.82607364654541, 685.326073884963989, 91.304346084594727, 18.673926115036011 ],
					"presentation" : 1,
					"presentation_rect" : [ 250.98040771484375, 171.56863808631897, 97.142869591712952, 19.047621488571167 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 246.326070547103882, 150.0, 60.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 84.239129781723022, 305.021721601486206, 29.5, 22.0 ],
									"text" : "- 36"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 120.652172565460205, 311.0, 29.5, 22.0 ],
									"text" : "- 24"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 161.804354906082153, 311.0, 29.5, 22.0 ],
									"text" : "- 12"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 323.804354906082153, 363.17389440536499, 35.0, 22.0 ],
									"text" : "clear"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 315.804354906082153, 100.0, 75.0, 22.0 ],
									"text" : "t b clear 127"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "int", "int", "int" ],
									"patching_rect" : [ 161.804354906082153, 389.0, 65.0, 22.0 ],
									"text" : "unpack i i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 161.804354906082153, 349.0, 49.0, 22.0 ],
									"text" : "$1 0 12"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 245.804354906082153, 250.0, 22.0, 22.0 ],
									"text" : "t b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 245.804354906082153, 359.91302490234375, 61.0, 22.0 ],
									"text" : "pipe 0 0 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "", "", "int" ],
									"patching_rect" : [ 245.804354906082153, 311.0, 92.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 315.804354906082153, 40.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 161.804354906082153, 473.192749000000049, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 196.804354906082153, 473.192749000000049, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 231.804354906082153, 473.192749000000049, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-28", 0 ],
									"midpoints" : [ 255.304354906082153, 411.1927490234375, 357.057589769363403, 411.1927490234375, 348.671908617019653, 249.03680419921875, 255.304354906082153, 249.03680419921875 ],
									"source" : [ "obj-29", 0 ]
								}
...
,
					"patching_rect" : [ 659.0, 744.021724939346313, 99.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 659.0, 772.0, 336.0, 53.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 104.0, 206.0, 22.0, 22.0 ],
									"text" : "t 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 51.0, 133.0, 80.0, 22.0 ],
									"text" : "speedlim 200"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "", "", "int" ],
									"patching_rect" : [ 52.0, 166.0, 61.0, 22.0 ],
									"text" : "counter 2"
								}
...
,
					"patching_rect" : [ 247.5, 179.0, 50.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 880.0, 399.0, 32.0, 22.0 ],
									"text" : "+ 24"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 863.0, 352.0, 29.5, 22.0 ],
									"text" : "% 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 965.0, 284.0, 50.5, 22.0 ],
									"text" : "cycle 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 999.75, 429.0, 29.5, 22.0 ],
									"text" : "- 12"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 938.0, 429.0, 32.0, 22.0 ],
									"text" : "+ 12"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 999.75, 385.0, 29.5, 22.0 ],
									"text" : "% 7"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 938.0, 368.0, 29.5, 22.0 ],
									"text" : "% 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 592.0, 404.0, 95.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 219.0, 275.0, 22.0, 22.0 ],
									"text" : "t 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 148.0, 293.0, 29.0, 22.0 ],
									"text" : "t 12"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 87.0, 409.0, 24.0, 24.0 ],
									"svg" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 1071.0, 429.0, 32.0, 22.0 ],
									"text" : "+ 12"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 390.0, 385.0, 103.0, 22.0 ],
									"text" : "scale 0. 1. 20 666"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 134.0, 473.0, 47.0, 22.0 ],
									"text" : "zl nth 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 87.0, 554.0, 32.0, 22.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 390.0, 423.0, 46.0, 22.0 ],
									"text" : "rate $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 313.0, 429.0, 61.0, 22.0 ],
									"text" : "enable $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 134.0, 385.0, 92.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 183.0, 248.0, 22.0, 22.0 ],
									"text" : "t 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 134.0, 429.0, 169.0, 22.0 ],
									"text" : "dk.datagranular @variation 33"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 254.0, 244.0, 22.0, 22.0 ],
									"text" : "t 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "bang", "bang", "bang", "" ],
									"patching_rect" : [ 151.5, 101.0, 122.0, 22.0 ],
									"text" : "sel bow pluck bow_hi"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 148.463074000000006, 40.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 87.0, 616.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 155.0, 616.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 417.5, 639.0, 97.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
					"text" : "p tremo-granular"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 452.0, 531.0, 128.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 207.0, 128.0, 20.0 ],
					"prototypename" : "onoff",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "Off", "On" ],
...
,
					"text" : "tremolo->retrigger",
					"texton" : "tremolo->retrigger",
					"varname" : "toggle-midi-note[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 194.75, 237.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 194.75, 302.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 194.75, 355.0, 29.5, 22.0 ],
					"text" : "* 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 194.75, 330.0, 33.0, 22.0 ],
					"text" : "* 1.3"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 194.75, 271.5, 159.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 250.98040771484375, 142.156871557235718, 91.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 247.5, 44.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 526.5, 602.0, 49.0, 22.0 ],
					"text" : "r speed"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 67.0, 93.0, 131.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 953.0, 82.0, 121.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 490.0, 110.5, 211.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 957.0, 161.0, 127.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 186.274521350860596, 129.411772727966309, 54.0, 21.0 ],
					"text" : "quantize",
					"textjustification" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 780.5, 103.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 780.5, 134.0, 102.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 662.5, 170.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 563.5, 172.0, 91.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 468.5, 173.0, 50.0, 18.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 681.0, 218.0, 29.5, 22.0 ],
									"text" : "+ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 183.0, 299.0, 42.0, 22.0 ],
									"text" : "gate 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "int" ],
									"patching_rect" : [ 206.0, 342.0, 48.0, 22.0 ],
									"text" : "change"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 206.0, 263.0, 175.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 206.0, 230.0, 47.0, 22.0 ],
									"text" : "zl nth 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 207.0, 169.0, 67.0, 22.0 ],
									"text" : "zl stream 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 206.0, 202.0, 68.0, 22.0 ],
									"text" : "array.mode"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 268.0, 317.0, 308.0, 33.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 239.0, 92.0, 32.0, 22.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 83.0, 383.5, 113.0, 22.0 ],
									"text" : "zmap -80 -16 0 127"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "float", "float", "float" ],
									"patching_rect" : [ 50.0, 424.5, 118.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 83.0, 322.5, 54.0, 22.0 ],
									"text" : "unpack f"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 246.0, 141.0, 95.0, 22.0 ],
									"text" : "dk.quantizepitch"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 506.5, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 83.0, 506.5, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 116.0, 506.5, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 68.5, 629.0, 101.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 117.0, 4.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 385.5, 350.0, 153.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 233.0, 304.0, 53.0, 18.0 ],
					"prototypename" : "time",
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
...
,
					"patching_rect" : [ 334.5, 103.0, 78.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 787.0, 243.5, 150.0, 33.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 449.0, 381.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 89.0, 211.0, 150.0, 87.0 ],
...
,
									"patching_rect" : [ 89.0, 137.0, 124.0, 22.0 ],
									"saved_object_attributes" : 									{
										"globalpatchername" : ""
									}
,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "float" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 380.0, 476.0, 100.0, 20.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 304.0, 181.0, 22.0, 22.0 ],
									"text" : "t 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 368.0, 249.0, 22.0, 22.0 ],
									"text" : "t 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 407.0, 334.0, 22.0, 22.0 ],
									"text" : "t 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 380.0, 539.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 89.000012099742889, 79.0, 506.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 223.0, 439.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 313.5, 323.9962158203125, 232.5, 323.9962158203125 ],
									"order" : 1,
									"source" : [ "obj-114", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 585.500012099742889, 125.834396362304688, 313.5, 125.834396362304688 ],
									"order" : 2,
									"source" : [ "obj-4", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-46", 0 ],
									"midpoints" : [ 585.500012099742889, 193.67669677734375, 377.5, 193.67669677734375 ],
									"order" : 1,
									"source" : [ "obj-4", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-6", 0 ],
									"midpoints" : [ 585.500012099742889, 284.656951904296875, 416.5, 284.656951904296875 ],
									"order" : 0,
									"source" : [ "obj-4", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-146", 0 ],
									"midpoints" : [ 377.5, 357.28692626953125, 232.5, 357.28692626953125 ],
									"order" : 1,
									"source" : [ "obj-46", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-146", 0 ],
									"midpoints" : [ 416.5, 377.5, 232.5, 377.5 ],
									"order" : 2,
									"source" : [ "obj-6", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-11", 0 ],
									"midpoints" : [ 416.5, 456.4310302734375, 389.5, 456.4310302734375 ],
									"source" : [ "obj-7", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-11", 0 ],
									"midpoints" : [ 377.5, 439.6558837890625, 389.5, 439.6558837890625 ],
									"source" : [ "obj-8", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-11", 0 ],
									"midpoints" : [ 313.5, 461.2618408203125, 389.5, 461.2618408203125 ],
									"source" : [ "obj-9", 0 ]
								}
...
,
					"patching_rect" : [ 334.5, 141.0, 77.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 219.5, 590.0, 65.0, 22.0 ],
					"text" : "r midi-bpm"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.5, 633.0, 71.0, 22.0 ],
					"text" : "quantize $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 289.5, 590.0, 63.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 186.274521350860596, 148.039224863052368, 54.0, 23.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 215.5, 633.0, 59.0, 22.0 ],
					"text" : "tempo $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 107.5, 587.0, 21.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 141.176479339599609, 129.411772727966309, 21.0, 21.0 ],
					"text" : "ch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 131.5, 587.0, 77.0, 22.0 ],
					"text" : "loadmess 12"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 61.5, 590.0, 52.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 125.490203857421875, 150.000009298324585, 52.0, 18.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 477.5, 408.0, 53.0, 22.0 ],
					"text" : "r portout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 376.5, 245.0, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 474.833333333333314, 245.0, 128.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 68.0, 146.0, 20.0 ],
					"prototypename" : "onoff",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "Off", "On" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 385.5, 408.0, 87.0, 22.0 ],
					"text" : "ctlout"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 376.5, 308.0, 159.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 151.0, 65.0, 189.0, 25.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 123.0, 531.0, 128.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 147.0, 128.0, 20.0 ],
					"prototypename" : "onoff",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "Off", "On" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 141.0, 818.0, 53.0, 22.0 ],
					"text" : "r portout"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 73.899369835853577, 844.0, 342.452824473381042, 22.0 ],
					"text" : "noteout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 318.0, 44.0, 22.0 ],
					"text" : "key $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 70.0, 275.0, 63.0, 28.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.857143223285675, 34.0, 96.142856776714325, 28.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 234.0, 84.0, 22.0 ],
					"text" : "prepend scale"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 298.0, 258.0, 107.0, 24.0 ],
					"text" : "CROSSFADE"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 26.0, 350.0, 614.0, 40.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 357.0, 22.0, 24.0 ],
					"text" : "B"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 309.0, 22.0, 24.0 ],
					"text" : "A"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 26.0, 301.0, 614.0, 40.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 26.0, 252.0, 614.0, 36.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 819.0, 44.0, 56.0, 22.0 ],
					"restore" : 					{
						"duration" : [ 500.0 ],
						"gate-receive-scenes" : [ 1.0 ],
						"gate-send-scenes" : [ 1.0 ],
						"inf-hold" : [ 0.0 ],
						"live.numbox[2]" : [ 43.931743621826172 ],
						"live.tab" : [ 0.0 ],
						"live.tab[1]" : [ 0.0 ],
						"live.tab[2]" : [ 8.0 ],
						"live.tab[3]" : [ 1.0 ],
						...
						"quantize" : [ 1 ],
						"quantize-scale" : [ 10 ],
						"toggle-flex-pitch" : [ 0.0 ],
						"toggle-midi-note" : [ 0.0 ],
						"toggle-midi-note[1]" : [ 0.0 ],
						"toggle-midi-note[2]" : [ 0.0 ],
						"toggle-midi-note[3]" : [ 0.0 ]
					}
,
					"text" : "autopattr",
					"varname" : "u082006233"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1165.0, 25.0, 635.0, 368.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 334.5, 69.0, 35.0, 22.0 ],
					"text" : "adc~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 563.5, 135.0, 209.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 74.0, 784.0, 150.0, 22.0 ]
				}

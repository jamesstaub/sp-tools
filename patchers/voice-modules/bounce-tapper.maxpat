...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 878.5, 124.0, 42.0, 22.0 ],
					"text" : "edge~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 686.5, 38.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 714.0, 248.5, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 86.0, 106.0, 57.0, 40.0 ],
					"presentation_linecount" : 2,
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.theme_textcolor"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 719.0, 541.0, 80.0, 40.0 ],
					"presentation_linecount" : 2,
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.theme_textcolor"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 227.0, 393.0, 66.0, 20.0 ],
					"text" : "current tap"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 151.0, 81.0, 343.0, 90.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 157.0, 515.0, 544.0, 90.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 235.0, 369.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 507.0, 481.0, 34.0, 21.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.theme_textcolor"
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 394.0, 481.0, 45.0, 21.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.theme_textcolor"
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 474.0, 377.0, 100.0, 100.0 ],
					"range" : [ -0.1, 1.1 ],
					"samples" : 88200.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 367.0, 377.0, 100.0, 100.0 ],
					"range" : [ -0.1, 1.1 ],
					"samples" : 88200.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 104.0, 420.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 151.0, 330.0, 341.0, 22.0 ],
					"text" : "dk.onsettap~ @speed 10 @timestretch 1 @timestretchmode 5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 878.5, 163.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 104.0, 81.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1018.5, 180.0, 150.0, 47.0 ],
					"text" : "create random flurry of playback taps 10% of the time an onset is detected"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "signal", "", "signal" ],
					"patching_rect" : [ 915.0, 209.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 706.0, 295.0, 42.0, 22.0 ],
					"text" : "edge~"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 204.5, 319.0, 160.5, 319.0 ],
					"source" : [ "obj-25", 0 ]
				}

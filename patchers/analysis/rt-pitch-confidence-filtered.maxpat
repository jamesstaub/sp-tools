...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 294.0, 117.0, 150.0, 194.0 ],
					"text" : "dk realtime pitch analysis.\n\ndoesnt perform well for low cello notes, so i've been using pesto~ instead.\n\n\nthis patch attempts to compensate by comparing the relative pitch, confidence and loudness to detect notes correctly in all ranges"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 234.0, 355.0, 146.0, 126.0 ],
...
,
					"patching_rect" : [ 180.0, 130.0, 78.0, 22.0 ],
					"text" : "p preprocess"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 26.0, 530.0, 150.0, 100.0 ],
									"text" : "lower notes have lower confidence, so depending on which filter catches the note, we scale up the confidence to make the results more normal across the note range"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 369.0, 602.0, 35.0, 22.0 ],
									"text" : "t 0. 2"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 311.0, 602.0, 45.0, 22.0 ],
									"text" : "t 0. 1.2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "float" ],
									"patching_rect" : [ 261.0, 602.0, 39.0, 22.0 ],
									"text" : "t 0. 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 167.0, 651.0, 90.0, 22.0 ],
									"text" : "scale 0. 1. 0. 1."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 26.0, 313.0, 150.0, 87.0 ],
...
, 							{
								"box" : 								{
									...
									"text" : "dk.descriptorsrt~ @fftsettings 4096 64 -1 @select loudness pitch pitch_confidence @history 0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 174.0, 731.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 191.0, 172.0, 77.0, 22.0 ],
					"text" : "p descriptors"
				}
...
, 			{
		...
		"originid" : "pat-3923",
		"parameters" : 		{
			"obj-11" : [ "live.tab[9]", "live.tab[9]", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",

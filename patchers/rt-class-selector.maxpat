...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"comment" : "subset list of classes",
					"id" : "obj-8",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 408.0, 290.0, 150.0, 315.0 ],
					"presentation" : 1,
					"presentation_linecount" : 19,
					"presentation_rect" : [ 5.0, 203.0, 181.0, 275.0 ],
					"text" : "the idea here is that all possible classnames are loaded in this collection and can be referenced elsewhere\n\n\nthese are fixed IDs used as classnames.\n\nactual classifiers will be trained on some subset of these (since there are diminishing returns on number of simultaneous classes)\n\nclassifiers can be saved and loaded up with different combinations of these classes.\n\n"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 311.0, 172.0, 77.0, 22.0 ],
					"text" : "route symbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 261.0, 155.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 311.0, 202.0, 51.0, 22.0 ],
					"text" : "zl group"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 396.0, 93.0, 39.0, 22.0 ],
					"text" : "dump"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 457.0, 88.0, 150.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 180.0, 41.0, 177.0, 20.0 ],
					"text" : "names of possible cello classes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.0, 520.0, 30.0, 30.0 ]
				}

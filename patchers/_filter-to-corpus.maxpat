...
, 							{
								"box" : 								{
									...
									"text" : "set 534.058957 12469.115646"
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1128.999999999999091, 805.0, 394.0, 49.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 566.0, 24.345848340979956, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 660.499999999999318, 362.889590837156732, 82.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 693.749999999999659, 416.889590837156675, 23.0, 23.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 122.387841085593209, 7.345848340979956, 118.0, 22.0 ],
					"restore" : 					{
						"comp-loudness" : [ 100.0 ],
						"comp-spectral" : [ 50.0 ],
						"corpus-menu" : [ 0 ],
						"granular-rate" : [ 92.500000000000014 ],
...
,
						"classnamespace" : "box",
						"rect" : [ -1879.0, 115.0, 1852.0, 931.0 ],
						"bglocked" : 0,
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 114.999999999999972, 829.0, 30.0, 30.0 ]
				}
...
,
					"patching_rect" : [ 722.749999999999773, 312.0, 108.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 117.0, 154.0, 108.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 1110.499999999999318, 28.0, 67.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.512841085592896, 30.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1287.0, 874.0, 128.0, 128.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1634.833331882953644, 203.270137054281122, 128.0, 128.0 ],
					"presentation" : 1,
